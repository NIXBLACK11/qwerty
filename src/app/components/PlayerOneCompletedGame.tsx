...
export const PlayerOneCompletedGame: React.FC<CompleteGameProps> = ({game}) => {
    const link = `https%3A%2F%2Fdial.to%2F%3Faction%3Dsolana-action%3Ahttps%3A%2F%2Fqwerty.nixblack.site%2Fapi%2Factions%2Fjoin-game%3FgameID%3D${game.id}%26name%3D${game.name}%26cluster%3Ddevnet`
    return (
