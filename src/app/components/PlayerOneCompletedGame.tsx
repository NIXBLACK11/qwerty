...
export const PlayerOneCompletedGame: React.FC<CompleteGameProps> = ({game}) => {
    const link = `https://dial.to/?action=solana-action%3Ahttp%3A%2F%2Flocalhost%3A3000%2Fapi%2Factions%2Fjoin-game%3FgameID%3D${game.id}%26name%3D${game.name}&cluster=devnet`
    return (
